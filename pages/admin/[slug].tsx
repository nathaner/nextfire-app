...
function PostManager() {
    ...
    const [post] = useDocumentData<{ title: string, username: string, slug: string }>(postRef)
        ...
        <main>
            {post && (
                <>
                    ...
                    <aside>
                        <h3>Tools</h3>
                        <button className="btn-blue" onClick={() => setPreview(!preview)}>{preview ? "Edit" : "Preview"}</button>
    ...
    return (
        <form onSubmit={handleSubmit(updatePost)}>
            ...
            <div className={preview ? styles.hidden : styles.controls}>
                ...
                <fieldset>
                    <input className={styles.checkbox} type="checkbox" name="published" ref={register} />
